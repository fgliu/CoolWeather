...
public class WeatherActivity extends Activity implements View.OnClickListener{
    ...
    private void queryWeatherInfo(String countryCode){
        String address = "http://www.weather.com.cn/adat/cityinfo/"+ countryCode + ".html";
        Log.e("fgliu",address);

        queryFromServer(address,"weatherCode");
    }

    private void queryFromServer(String address, final String weatherCode) {

        HttpUtil.sendHttpRequest(address, new HttpCallBackListener() {
            @Override
            public void onFinish(String response) {
                if("weatherCode".equals(weatherCode)){
